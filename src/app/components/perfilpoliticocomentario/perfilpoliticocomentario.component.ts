...
@Component({
  selector: 'app-perfilpoliticocomentario',
  templateUrl: './perfilpoliticocomentario.component.html',
  styleUrls: ['./perfilpoliticocomentario.component.scss'],
})
export class PerfilpoliticocomentarioComponent implements OnInit {
  ...
  async salvar() {
    ...
    load.present();
    this.comentario.politico_id = this.relacao.id
