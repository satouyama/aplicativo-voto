...
@Component({
  selector: 'app-perfilusuariocomentario',
  templateUrl: './perfilusuariocomentario.component.html',
  styleUrls: ['./perfilusuariocomentario.component.scss'],
})
export class PerfilusuariocomentarioComponent implements OnInit {
  ...
  async salvar() {
    ...
    load.present();
    this.comentario.eleitor_id = this.relacao.id
